...
Walks <videos_dir> for common video extensions, calls the relay transcribe
proxy on each, writes transcripts to <videos_dir>/edit/transcripts/<name>.json.
...
from transcribe import load_auth, transcribe_one
